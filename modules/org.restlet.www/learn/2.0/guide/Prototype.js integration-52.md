...
-   [What's
    RESTful](http://web.archive.org/web/20111020181733/http://www.xfront.com/REST-Web-Services.html)[?](http://web.archive.org/web/20111020181733/http://www.xfront.com/REST-Web-Services.html)
-   [What's
    Restlet?](http://web.archive.org/web/20111020181733/http://www.restlet.org/documentation/1.1/api/index.html)
-   [How to use
    Restlet?](http://web.archive.org/web/20111020181733/http://www.restlet.org/documentation/1.1/tutorial)
-   [How to use db4o to simplify
    persistence?](http://web.archive.org/web/20111020181733/http://db4o.com/about/productinformation/resources/db4o-6.3-tutorial-java.pdf)
-   [How to use JSON in
    Prototype.js?](http://web.archive.org/web/20111020181733/http://www.prototypejs.org/learn/json)
...
-   Server handle process:
    [Application](http://web.archive.org/web/20111020181733/http://www.restlet.org/documentation/1.1/api/org/restlet/Application.html)
    dispatches request to
    [Router](http://web.archive.org/web/20111020181733/http://www.restlet.org/documentation/1.1/api/org/restlet/Router.html),
...
model](http://web.archive.org/web/20111020181733/http://developer.db4o.com/resources/api/db4o-java/com/db4o/Db4o.html).If
you have requirement,you should modify it in concurrent(client/server)
model by using [Db4o.openServer
method](http://web.archive.org/web/20111020181733/http://developer.db4o.com/resources/api/db4o-java/com/db4o/Db4o.html#openServer%28java.lang.String,%20int%29).
...
### 
  ...
  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  [![running\_applicaion](Prototype.js%20integration-52_files/data.html "running_applicaion")](http://web.archive.org/web/20111020181733/http://wiki.restlet.org/docs_2.0/53-restlet/version/default/part/ImageData/data)
  [Click to enlarge](http://web.archive.org/web/20111020181733/http://wiki.restlet.org/docs_2.0/53-restlet/version/default/part/ImageData/data)
  -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Checkout Full Code
==================

[microblog\_sourcecode](http://web.archive.org/web/20111020181733/http://wiki.restlet.org/docs_2.0/54-restlet/version/default/part/AttachmentData/data "microblog_sourcecode")
(application/x-zip, 2.3 MB,
[info](http://web.archive.org/web/20111020181733/http://wiki.restlet.org/docs_2.0/54-restlet.html))
...
Sure, you can custom a finder to do what tunnelService do.\
 You can visit
[http://dobrzanski.net/2007/04/22/using-put-and-delete-methods-in-ajax-requesta-with-prototypejs/](http://web.archive.org/web/20111020181733/http://dobrzanski.net/2007/04/22/using-put-and-delete-methods-in-ajax-requesta-with-prototypejs/)
