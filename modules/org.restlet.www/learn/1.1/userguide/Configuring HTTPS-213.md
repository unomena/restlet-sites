...
](http://web.archive.org/web/20120411173137/http://somedir//serverX.jks)-Djavax.net.ssl.trustStoreType=JKS\
...
// Note refactoring in Restlet version 1.2:\
 // **com.noelios.restlet.ext.ssl**.PkixSslContextFactory moved to
...
**org.restlet.engine.security**.DefaultSslContextFactory");\
 //\
 // DefaultSslContextFactory is another sslContextFactory that can be
used if desired.
...
[Comments
(0)](http://web.archive.org/web/20120411173137/http://wiki.restlet.org/docs_1.1/13-restlet/27-restlet/46-restlet/213-restlet.html#)

Comments
[Hide](http://web.archive.org/web/20120411173137/http://wiki.restlet.org/docs_1.1/13-restlet/27-restlet/46-restlet/213-restlet.html#)
\
