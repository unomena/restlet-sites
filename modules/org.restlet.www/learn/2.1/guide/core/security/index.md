...
[Cookie](http://web.archive.org/web/20120102222530/http://www.restlet.org/documentation/2.0/api/org/restlet/data/Cookie.html)
and
[CookieSetting](http://web.archive.org/web/20120102222530/http://www.restlet.org/documentation/2.0/api/org/restlet/data/CookieSetting.html)
objects accessible from a
[Request](http://web.archive.org/web/20120102222530/http://www.restlet.org/documentation/2.0/api/org/restlet/data/Request.html)
or a
[Response](http://web.archive.org/web/20120102222530/http://www.restlet.org/documentation/2.0/api/org/restlet/data/Response.html).
...
[Filter](http://web.archive.org/web/20120102222530/http://java.sun.com/j2ee/1.4/docs/api/javax/servlet/Filter.html)
...
([see specifications
here](http://web.archive.org/web/20120102222530/http://wiki.restlet.org/developers/172-restlet/212-restlet.html)).
...
connector](http://web.archive.org/web/20120102222530/http://wiki.restlet.org/docs_2.1/38-restlet.html),
it is possible to configure the SSL connectors using an
[SslContextFactory](http://web.archive.org/web/20120102222530/http://www.restlet.org/documentation/2.1/engine/org/restlet/engine/util/SslContextFactory.html),
...
2.  When no `sslContextFactory` *attribute* is set, the full name of a
    ...
    SslContextFactory instance via text parameters.\
     The
    [org.restlet.engine.security.DefaultSslContextFactory](http://web.archive.org/web/20120102222530/http://www.restlet.org/documentation/2.0/jse/engine/org/restlet/engine/security/DefaultSslContextFactory.html#init%28org.restlet.util.Series%29)
    ...
    guide](http://web.archive.org/web/20120102222530/http://java.sun.com/j2se/1.5.0/docs/guide/security/jsse/JSSERefGuide.html#SystemProps)).\
...
known as
"[XSRF](http://web.archive.org/web/20120102222530/http://en.wikipedia.org/wiki/XSRF)"
...
[XSS](http://web.archive.org/web/20120102222530/http://en.wikipedia.org/wiki/Cross-site_scripting)
...
[Security
sample](http://web.archive.org/web/20120102222530/http://wiki.restlet.org/docs_2.1/307-restlet/version/default/part/AttachmentData/data/Security%20sample.zip "Security sample")
(application/zip, 2.9 kB,
[info](http://web.archive.org/web/20120102222530/http://wiki.restlet.org/docs_2.1/307-restlet.html))

[Comments
(2)](http://web.archive.org/web/20120102222530/http://wiki.restlet.org/docs_2.1/13-restlet/27-restlet/46-restlet.html#)

Comments
[Hide](http://web.archive.org/web/20120102222530/http://wiki.restlet.org/docs_2.1/13-restlet/27-restlet/46-restlet.html#)
\

Created by Sabolc Gleser on 5/4/11 12:45:33 PM

Hi, \
I am developing with my team a web application which uses Reslet with
GAE. My problem is in the security layer, I created my own Authenticator
and Authorizer but, how can I apply at the same time those to the
resources when I create the router? Each Resource should have his own
authenticator and authorizer. They extend one which is the super class
for all, but some of them should have some changes and because of that.
In Restlet 1.1 it was easy, I created a class which extended the Guard
class and attached the Resource to him, but here it doesn't work.

Created by Sabolc Gleser on 5/4/11 1:05:41 PM

A managed this way , it is working but I'm not sure it's correct :\
 \
 LoginAuthenticator loginAuthenticator = new
LoginAuthenticator(getContext(), ChallengeScheme.HTTP\_BASIC,
"Tutorial");\
 \
 LoginAuthorizer loginAuthorizer = new LoginAuthorizer(getContext(),
ChallengeScheme.HTTP\_BASIC, "Tutorial");\
 \
 loginAuthenticator.setNext(loginAuthorizer);\
 loginAuthorizer.setNext(LoginResource.class);\
 \
 router.attach("/login", loginAuthorizer);\
 \
where LoginAuthenticator extends ChallengeAuthenticator and \
LoginAuthorizer extend Authorizer
