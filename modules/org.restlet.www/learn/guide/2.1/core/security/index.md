...
connector](http://wiki.restlet.org/docs_2.1/38-restlet.html),
it is possible to configure the SSL connectors using an
[SslContextFactory](http://www.restlet.org/documentation/2.1/engine/org/restlet/engine/util/SslContextFactory.html),
...
[Security
sample](http://wiki.restlet.org/docs_2.1/307-restlet/version/default/part/AttachmentData/data/Security%20sample.zip "Security sample")
(application/zip, 2.9 kB,
[info](http://wiki.restlet.org/docs_2.1/307-restlet.html))
