...
API,
[mapping](/learn/guide/2.1#/13-restlet/27-restlet/130-restlet.html "Mapping HTTP headers")all
REST and HTTP concepts to a set of Java classes, interfaces and
annotations.

[Let's now illustrate how to use this API on the
client-side](/learn/guide/2.1#/13-restlet/21-restlet/318-restlet/320-restlet.html "First client").
