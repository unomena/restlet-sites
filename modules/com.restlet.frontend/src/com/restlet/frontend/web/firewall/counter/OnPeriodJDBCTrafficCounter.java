...
import com.restlet.frontend.web.firewall.counter.individualCounter.IndividualOnPeriodJDBCTrafficCounter;
...
public class OnPeriodJDBCTrafficCounter extends OnPeriodTrafficCounter {
    ...
    public IndividualOnPeriodTrafficCounter initializeIndividualTrafficCounter() {
        return new IndividualOnPeriodJDBCTrafficCounter();
    }
