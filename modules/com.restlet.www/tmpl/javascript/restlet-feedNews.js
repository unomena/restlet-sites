    $(document).ready(function() {
		...
		crGeneral.get(function(representation) {
			...
			var listContent = "";
   			...
   			if(elements.length && elements.length>0){
	   			listContent = "<h4 class=\"blog\"><a href=\"http://blog.restlet.com/feed/?cat=894539\">Restlet - General&nbsp;<img src=\"/images/icons/feed-20.png\" alt=\"Syndication feed\" style=\"margin:5px\"/></a></h4>";
		...
		crReleases.get(function(representation) {
			...
			var listContent = "";
   			var elements = jsonRepresentation.getObject();
   			if(elements.length && elements.length>0){
	   			listContent = "<h4 class=\"blog\"><a href=\"http://blog.restlet.com/feed/?cat=894542\">Restlet - Releases&nbsp;<img src=\"/images/icons/feed-20.png\" alt=\"Syndication feed\" style=\"margin:5px\"/></a></h4>";
	   			listContent += "<ul class=\"blog\">";
	   			for (var i=0; i < elements.length; i++) {
	   				listContent += createFeedElement(elements[i]);
	   			}
