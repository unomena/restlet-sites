...
A public API is not necessarily open to anyone at runtime. This is configured from the [User Groups](apispark/guide/secure/user-groups "User groups") page.
...
APISpark web APIs respect the principles of REST. Therefore, CRUD operations can be performed on resources exposed by APIs.
